# Reference-only template that documents the Terraform Cloud
# workspace variables consumed by this agent. Do not populate
# with literal secrets. Each assignment references the matching
# Terraform Cloud workspace variable.
